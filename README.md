...
Учебный REST API сервис для управления задачами. Писал чтобы разобраться с JWT-аутентификацией, двухфакторной верификацией и микросервисной архитектурой. Фишка проекта — при входе Telegram-бот присылает одноразовый код, без которого не получить токены.
